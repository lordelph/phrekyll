...
class OutputPathTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEntriesPaths()
    {
        ...
        $view
            ->setInputFile('/var/www/phrekyll-test/entries/some-entry.twig')
            ->setOutputDir('/var/www/output');
        $path = new OutputPath\Entry($view);
        $this->assertSame('/var/www/output/some-entry.html', $path->get());

        $view
            ->setInputFile('/var/www/phrekyll-test/entries/sub/folder/some-entry.twig')
            ->setOutputDir('/var/www/output');
        $path->setView($view);
        $this->assertSame('/var/www/output/sub/folder/some-entry.html', $path->get());

        $view
            ->setInputFile('/var/www/phrekyll-test/sub/folder/some-entry.twig')
            ->setOutputDir('/var/www/output');
        $path->setView($view);
        $this->assertSame('/var/www/output/sub/folder/some-entry.html', $path->get());
    }
    ...
    public function testStylesPaths()
    {
        ...
        $view
            ->setInputFile('/var/www/phrekyll-test/styles/some-entry.less')
            ->setOutputDir('/var/www/output');
        $path = new OutputPath\Style($view);
        $this->assertSame('/var/www/output/styles/some-entry.css', $path->get());

        $view
            ->setInputFile('/var/www/phrekyll-test/styles/sub/folder/some-entry.less')
            ->setOutputDir('/var/www/output');
        $path->setView($view);
        $this->assertSame('/var/www/output/styles/sub/folder/some-entry.css', $path->get());

        $view
            ->setInputFile('/var/www/phrekyll-test/sub/folder/some-entry.less')
            ->setOutputDir('/var/www/output');
        $path->setView($view);
    ...
    public function testScriptsPaths()
    {
        ...
        $view
            ->setInputFile('/var/www/phrekyll-test/scripts/some-entry.js')
            ->setOutputDir('/var/www/output');
        $path = new OutputPath\Script($view);
        $this->assertSame('/var/www/output/scripts/some-entry.js', $path->get());

        $view
            ->setInputFile('/var/www/phrekyll-test/scripts/sub/folder/some-entry.js')
            ->setOutputDir('/var/www/output');
        $path->setView($view);
        $this->assertSame('/var/www/output/scripts/sub/folder/some-entry.js', $path->get());

        $view
            ->setInputFile('/var/www/phrekyll-test/sub/folder/some-entry.js')
            ->setOutputDir('/var/www/output');
        $path->setView($view);
