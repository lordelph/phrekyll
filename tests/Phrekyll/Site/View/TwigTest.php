...
class TwigTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $twig = dirname(__FILE__) . '/../project/.phrekyll/entries/twig-child-with-fm.twig';
        $html = dirname(__FILE__) . '/../project/.phrekyll/entries/twig-child-with-fm.html';
        $view = new View($twig);
    ...
    {
        $twig = dirname(__FILE__) . '/../project/.phrekyll/entries/twig-include.twig';
        $html = dirname(__FILE__) . '/../project/.phrekyll/entries/twig-include.html';
        $view = new View($twig);
    ...
    {
        $twig = dirname(__FILE__) . '/../project/.phrekyll/entries/compile-permalink-append-index.twig';
        $html = dirname(__FILE__) . '/../project/.phrekyll/entries/compile-permalink.html';
        $path = dirname(__FILE__) . '/out/';
        $view = new View($twig, $path);
    ...
    {
        $twig = dirname(__FILE__) . '/../project/.phrekyll/entries/compile-permalink-parametrized.twig';
        $html = dirname(__FILE__) . '/../project/.phrekyll/entries/compile-permalink.html';
        $path = dirname(__FILE__) . '/out/';
        $view = new View($twig, $path);
    ...
    {
        $twig = dirname(__FILE__) . '/../project/.phrekyll/entries/2011-02-24-no-front-matter.twig';
        $html = dirname(__FILE__) . '/../project/.phrekyll/entries/2011-02-24-no-front-matter.html';
        $view = new View($twig);
